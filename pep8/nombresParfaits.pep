...
;
;       Programme qui demande un nombre � l'utilisateur
;       puis affiche la somme et dit s'il s'agit d'un
;       nombre parfait ou non.
;       Lorsqu'il y a d�bordement, la somme n'est pas
;       affich�e et le programme affiche directement
...
fin:     LDA     cmpEss,d    ;
         ...
         ;=============================
init:    LDA     0,i         ; initialisation � 0 des variables
         STA     somme,d     ; somme
         STA     cmpM,d      ; compteur de moitie
         LDA     1,i         ; initialisation � 1 des variables
...
invalid: .ASCII  "\x0AEntr�e est invalide.\x0A\x00"
entier:  .WORD   0           ; entier saisi au clavier
nbEssai: .WORD   5           ; nombre de tentatives
div:     .WORD   1           ; diviseur
cmpEss:  .WORD   1           ; compteur du nombre d'exc�cution
